          ...
          <div class="container">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card">
                      <div class="card-body">
                         <form action="bookhallpaymentprocessor.php" method="post">
                        ...
                        <div class="form-group">
                              ...
                              <input class="form-control" type="text" id="amount" name="hall_amount" value="2,50,000" readonly></input>
                        </div>
                            
                          <input type="submit" value="Make Payment" id="submit" name="submit">
